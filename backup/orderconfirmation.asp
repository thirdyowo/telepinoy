...
<%
  ...
  If Request.ServerVariables("HTTP_REFERER")<>"http://localhost/checkout.asp" Then Response.Redirect("index.asp")
  End If
%>
...
<p class="center">
  ...
  <%
    ...
    If IsObject(Session("shoppingcart"))=True Then
      ...
      For c = 0 to cart.Count - 1
        productname = k(c)
        quantity = cart.Items(productname)
  ...
  <p>
    Your order has been recorder in our system.
