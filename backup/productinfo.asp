...
Set rs.Cart=Server.CreateObject("ADODB.Recordset")
...
Total amount: <%=FormatNumber(toalPrice,2)%> PHP
</p>

<br>
Payment mode:
<select mode="paymentmodeid">
